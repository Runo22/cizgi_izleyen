...
double sagBase = 15;//150; //70Motor tam olarak çizgideyken alacağı değer // 150 // 200
double solBase = 15;//15 //70 Motor tam olarak çizgideyken alacağı değer // 150 //200
double motorHiz = 0;
...
void engel(){
  ...
  if ((sayac == 0) && (engelVeri == 1)){
    sol_dur();
    sag_ileri(10);     // bura oyna engel icin
    delay(150);
    sag_ileri(30);
    sol_ileri(30);
    sayac++;
